            ...
            <About>
                <About.AboutFrameInner>
                    ...
                    <About.TextFrame>
                        ...
                        <About.Text>- I also have a love for Crypto! From making my first investment in 2016, to setting up ETH2.0 validators, to creating <span style={aStyle} onClick={()=> openInNewTab("https://chainfeed.io")}>ChainFeed.io</span> with Web3.js, I have a wide array of knowledge accross the industry.</About.Text>
                    </About.TextFrame>
                </About.AboutFrameInner>
            </About>
        </>
