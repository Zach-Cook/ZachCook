            ...
            <About id="about">
                <About.AboutFrameInner>
                    ...
                    <About.TextFrame>
                        ...
                        <About.Text>- I also have a love for Crypto! From learning since 2016 to setting up ETH2.0 Testnet Validators, to creating <span style={aStyle} onClick={()=> openInNewTab("https://chainfeed.io")}>ChainFeed.io</span> with Web3.js and Chainlink oracles, I have an array of knowledge accross the industry.</About.Text>
                    </About.TextFrame>
                </About.AboutFrameInner>
            </About>
        </>
